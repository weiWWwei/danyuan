...
public class StudentController {
    ...
    public Result<?> addStudent(@RequestBody Student student){
        ...
        Student student1 = studentService.getStudentByNumber(student.getNumber());
        if(student1!=null) {
            return Result.fail(20001,"党员编号已存在");
        }
    ...
    @DeleteMapping("/{id}")
    public Result<Student> deleteStudentById(@PathVariable("id") Integer id){
